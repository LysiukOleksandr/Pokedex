...
const PokemonDetails = ({ match }) => {
  ...
  return (
    <div className="pokemon-details">
      ...
      <p className="pokemon-details__weight">
        Weight: {details && details.weight}
      </p>
      <p className="pokemon-details__height">
